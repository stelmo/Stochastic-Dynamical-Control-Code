...
us[1] = MPC.mpc_var(pfmeans[:, 1], pfcovars[:,:, 1], horizon, A, B, b, aline, bline, cline, QQ, RR, ysp, 25000.0, 1000.0, false, 1.0)# get the controller input
tic()
for t=2:N
  ...
  us[t] = MPC.mpc_var(pfmeans[:, t]-b, pfcovars[:, :, t], horizon, A, B, b, aline, bline, cline, QQ, RR, ysp, 25000.0, 1000.0, false, 1.0)
end
toc()
