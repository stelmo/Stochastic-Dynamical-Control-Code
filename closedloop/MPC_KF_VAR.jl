...
us[1] = MPC.mpc_var(kfmeans[:, 1], predvar, horizon, A, B, b, aline, bline, cline, QQ, RR, ysp, 15000.0, false) # get the controller input
...
for t=2:N
  ...
  us[t] = MPC.mpc_var(kfmeans[:, t], predvar, horizon, A, B, b, aline, bline, cline, QQ, RR, ysp, 15000.0, false) # get the controller input
end
kfmeans = kfmeans .+ b
