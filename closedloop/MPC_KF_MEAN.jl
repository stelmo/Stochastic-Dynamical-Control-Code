...
us[1] = MPC.mpc_mean(kfmeans[:, 1], horizon, A, B, b, aline, bline, cline, QQ, RR, ysp, true)# get the controller input
...
for t=2:N
  ...
  us[t] = MPC.mpc_mean(kfmeans[:, t], horizon, A, B, b, aline, bline, cline, QQ, RR, ysp, true)
